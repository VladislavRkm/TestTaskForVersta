...
Хорошее на этом, к сожалению, заканчивается. Ибо техническая реализация **полностью готова**___(можно убедиться в папке frontend)___, но страница не открывается из-за неизвестной мне ошибки. К несчастью, у меня нет опыта frontend-разработки, и возможно, мне стоило выбрать более лёгкий путь и писать frontend с использованием ASP.NET MVC, но время на переписывание frontend части уже вышло. Я бы с удовольствием довёл до ума этот проект, если бы мне дали фидбэк и направили в нужное русло для исправления данной ошибки. Спасибо!
